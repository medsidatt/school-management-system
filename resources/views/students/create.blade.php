                                ...
                                <div class="col-md-4">
                                    ...
                                    <select id="class" name="class" class="form-select @error('class') is-invalid @enderror">
                                        ...
                                        @foreach($classes as $class)
                                            <option {{ isset($student->c_id) && $student->c_id == $class->id ? 'selected' : '' }} value="{{ $class->id }}">{{ $class->name }}</option>
                                        @endforeach
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" id="p_first_name" name="p_first_name"
                                               ...
                                               value="{{ old('p_first_name', $student->p_fn ?? '') }}">
                                        @error('p_first_name')
                                        <span class="invalid-feedback">{{ $message }}!</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" id="p_last_name" name="p_last_name"
                                               ...
                                               value="{{ old('p_last_name', $student->p_ln ?? '') }}">
                                        @error('p_last_name')
                                        <span class="invalid-feedback">{{ $message }}!</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="p_sex" id="p_sex"
                                            ...
                                            <option value="">~ Sexe</option>
                                            <option {{ isset( $student->p_sex) &&  $student->p_sex == "M" ? 'selected' : '' }} value="M">Masculin</option>
                                            <option {{ isset( $student->p_sex) &&  $student->p_sex == "F" ? 'selected' : '' }} value="F">Feminin</option>
                                        </select>
                                        @error('p_sex')
                                        <span class="invalid-feedback">{{ $message }}!</span>
                                        @enderror
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" id="p_date_of_birth" name="p_date_of_birth"
                                               ...
                                               value="{{ old('p_date_of_birth', $student->p_dob ?? '') }}">
