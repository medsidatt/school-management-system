...
@section('content')
    <div class="pagetitle">
        <h1 class="mb-1">Les note du 1<sup>er</sup> devoir</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item">Devoir 1</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card w-auto">
                    <div class="card-body">
                        <div class="col"><p class="card-title">Tout les note du devoir du 1<sup>er</sup> trimestre</p></div>
                        <div class="row mb-2">
                            <form id="test-form">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#send-button').click(function (e) {
                ...
                $.ajax({
                    url: "{{ route('tests.quarters.first') }}",
                    type: "POST",
                    data: data,
                    dataType: "JSON",
                    processData: false,
        ...
        function classFunc(event) {
            ...
            if (classId === '' && $.fn.DataTable.isDataTable('#tests')) {
                ...
                $.ajax({
                    url: "{{ route('tests.quarters.first.filtered', '') }}",
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: {
                        ...
                        action: function () {
                            $.ajax({
                                url: "{{ route('tests.quarters.first.delete') }}",
                                method: 'POST',
                                data: {id: id},
