...
@section('content')
    <div class="pagetitle">
        <h1 class="mb-1">Les note du 3<sup>em</sup> devoir</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item">Devoir 3</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#send-button').click(function (e) {
                ...
                $.ajax({
                    url: "{{ route('tests.quarters.third') }}",
                    type: "POST",
                    data: data,
                    dataType: "JSON",
                    processData: false,
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: {
                        ...
                        action: function () {
                            $.ajax({
                                url: "{{ route('tests.quarters.third.delete') }}",
                                method: 'POST',
                                data: {id: id},
