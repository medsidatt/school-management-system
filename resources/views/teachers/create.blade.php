                                ...
                                <div class="col">
                                    <div>
                                        <div class="mb-4 d-flex justify-content-center">
                                            <img id="selectedImage" src="{{ asset('assets/img/placeholder.jpg') }}"
                                                 alt="Selectioner une image" style="width: 300px;" />
                                        </div>

                                        <div class="d-flex justify-content-center">
                                            <div class="btn btn-primary btn-rounded">
                                                <label class="form-label text-white m-1" for="img_path">Choisir une profile</label>
                                                <input type="file" id="img_path" name="img_path"
                                                       class="form-control d-none @error('img_path') is-invalid @enderror" onchange="displaySelectedImage(event, 'selectedImage')"
