    ...
    return function () {
        ...
        var e = {
            172: function (t, e) {
                ...
                var o = n(4), r = n(136), i = n(744), l = n(776), a = n(664), s = n(972);
                e.default = function (t) {
                    t.API.autoTable = function () {
                        ...
                        var r = new i.DocHandler(this), l = (0, o.parseHtml)(r, t, window, e, !1), a = l.head,
                            s = l.body;
                        return {
                            columns: (null === (n = a[0]) || void 0 === n ? void 0 : n.map((function (t) {
                                return t.content
                            }))) || [], rows: s, data: s
                        }
                ...
                Object.defineProperty(e, "__esModule", {value: !0}), e.default = function (t, e, n, o, r) {
                    o = o || {};
                    var i = r.internal.scaleFactor, l = r.internal.getFontSize() / i,
                        a = l * (r.getLineHeightFactor ? r.getLineHeightFactor() : 1.15), s = "", u = 1;
                    if ("middle" !== o.valign && "bottom" !== o.valign && "center" !== o.halign && "right" !== o.halign || (u = (s = "string" == typeof t ? t.split(/\r\n|\r|\n/g) : t).length || 1), n += l * (2 - 1.15), "middle" === o.valign ? n -= u / 2 * a : "bottom" === o.valign && (n -= u * a), "center" === o.halign || "right" === o.halign) {
                        var d = l;
                        if ("center" === o.halign && (d *= .5), s && u >= 1) {
                            for (var h = 0; h < s.length; h++) r.text(s[h], e - r.getStringUnitWidth(s[h]) * d, n), n += a;
                            return r
                        }
                ...
                Object.defineProperty(e, "__esModule", {value: !0}), e.getPageAvailableWidth = e.parseSpacing = e.getFillStyle = e.addTableBorder = e.getStringWidth = void 0, e.getStringWidth = function (t, e, n) {
                ...
                }, e.getFillStyle = n, e.parseSpacing = o, e.getPageAvailableWidth = function (t, e) {
                    var n = o(e.settings.margin, 0);
                ...
                e.parseCss = function (t, e, n, i, l) {
                    ...
                    h && (a.cellPadding = h);
                    var c = "borderTopColor", f = s * n, g = i.borderTopWidth;
                    if (i.borderBottomWidth === g && i.borderRightWidth === g && i.borderLeftWidth === g) {
                        var p = (parseFloat(g) || 0) / f;
                        p && (a.lineWidth = p)
                    } else a.lineWidth = {
                        top: (parseFloat(i.borderTopWidth) || 0) / f,
                        right: (parseFloat(i.borderRightWidth) || 0) / f,
                        bottom: (parseFloat(i.borderBottomWidth) || 0) / f,
                        left: (parseFloat(i.borderLeftWidth) || 0) / f
                    ...
                    console.log(a.lineWidth);
                    var y = r(e, (function (t) {
                        return l.getComputedStyle(t)[c]
                    }));
                    null != y && (a.lineColor = y);
                    var v = ["left", "right", "center", "justify"];
                    -1 !== v.indexOf(i.textAlign) && (a.halign = i.textAlign), -1 !== (v = ["middle", "bottom", "top"]).indexOf(i.verticalAlign) && (a.valign = i.verticalAlign);
                    var m = parseInt(i.fontSize || "");
                    isNaN(m) || (a.fontSize = m / s);
                    var b = function (t) {
                        var e = "";
                    ...
                    b && (a.fontStyle = b);
                    var w = (i.fontFamily || "").toLowerCase();
                    return -1 !== t.indexOf(w) && (a.font = w), a
                }
            }, 744: function (t, e) {
                ...
                var o = n(4), r = n(356), i = n(420), l = n(744), a = n(792);
                e.parseInput = function (t, e) {
                    var n = new l.DocHandler(t), s = n.getDocumentOptions(), u = n.getGlobalOptions();
                    (0, a.default)(n, u, s, e);
                    var d, h = (0, r.assign)({}, u, s, e);
                    ...
                    var c = function (t, e, n) {
                        ...
                        for (var o = {
                            ...
                            var l = i[r];
                            l.didParseCell && o.didParseCell.push(l.didParseCell), l.willDrawCell && o.willDrawCell.push(l.willDrawCell), l.didDrawCell && o.didDrawCell.push(l.didDrawCell), l.willDrawPage && o.willDrawPage.push(l.willDrawPage), l.didDrawPage && o.didDrawPage.push(l.didDrawPage)
                        }
                        return o
                    }(u, s, e), g = function (t, e) {
                        var n, o, r, l, a, s, u, d, h, c, f, g, p, y,
                            v = (0, i.parseSpacing)(e.margin, 40 / t.scaleFactor()), m = null !== (n = function (t, e) {
                                ...
                                return null
                            }(t, e.startY)) && void 0 !== n ? n : v.top;
                        p = !0 === e.showFoot ? "everyPage" : !1 === e.showFoot ? "never" : null !== (o = e.showFoot) && void 0 !== o ? o : "everyPage";
                        y = !0 === e.showHead ? "everyPage" : !1 === e.showHead ? "never" : null !== (r = e.showHead) && void 0 !== r ? r : "everyPage";
                        var b = null !== (l = e.useCss) && void 0 !== l && l, w = e.theme || (b ? "plain" : "striped"),
                            P = !!e.horizontalPageBreak,
                        ...
                        return {
                            ...
                            horizontalPageBreak: P,
                            horizontalPageBreakRepeat: S,
                            horizontalPageBreakBehaviour: null !== (g = e.horizontalPageBreakBehaviour) && void 0 !== g ? g : "afterAllRows"
                        }
                    }(n, h), p = function (t, e, n) {
                        var r = e.head || [], i = e.body || [], l = e.foot || [];
                        if (e.html) {
                            var a = e.includeHiddenHtml;
                            if (n) {
                                var s = (0, o.parseHtml)(t, e.html, n, a, e.useCss) || {};
                                r = s.head || r, i = s.body || r, l = s.foot || r
                            } else console.error("Cannot parse html in non browser environment")
                        }
                        var u = e.columns || function (t, e, n) {
                            var o = t[0] || e[0] || n[0] || [], r = [];
                            return Object.keys(o).filter((function (t) {
                                ...
                                for (var i = 0; i < n; i++) {
                                    var l = {dataKey: Array.isArray(o) ? r.length : t + (i > 0 ? "_".concat(i) : "")};
                                    r.push(l)
                                }
                            })), r
                        }(r, i, l);
                        return {columns: u, head: r, body: i, foot: l}
                    }(n, h, d);
                    return {id: e.tableId, content: p, hooks: f, styles: c, settings: g}
                }
            }, 792: function (t, e) {
                function n(t) {
                ...
                var o = n(796), r = n(172), i = n(420), l = function () {
                    function t(t, e) {
                    ...
                    return t.prototype.getHeadHeight = function (t) {
                        ...
                        for (var n = 0, o = this.hooks.willDrawPage; n < o.length; n++) {
                            (0, o[n])(new r.HookData(t, this, e))
                        }
                ...
                var a = function () {
                    ...
                    return t.prototype.getMaxCellHeight = function (t) {
                        ...
                        return t.reduce((function (t, o) {
                            var r = n.cells[o.index];
                            if (!r) return 0;
                            var i = e.getLineHeight(r.styles.fontSize), l = r.padding("vertical") + i;
                            return l > t ? l : t
                        }), 0)
                    }, t
                }();
                ...
                var o = n(744), r = n(260), i = n(324), l = n(796), a = n(356);
                ...
                function d(t, e, n, o, r, i, s) {
                    ...
                    var h = (0, a.assign)({}, d.table, d[t], r.styles, u),
                        ...
                        p = (0, l.defaultStyles)(i), y = (0, a.assign)({}, p, h, g, f);
                ...
                var o = n(420), r = n(260), i = n(744), l = n(356), a = n(136), s = n(224);
                ...
                function d(t, e, n, o, r, i) {
                    t.applyStyles(t.userStyles), i = null != i ? i : e.body.length;
                    var l = Math.min(n + i, e.body.length), a = -1;
                    return e.body.slice(n, l).forEach((function (i, l) {
                        var s = n + l === e.body.length - 1, u = y(t, e, s, o);
                        i.canEntireRowFit(u, r) && (g(t, e, i, o, r), a = n + l)
                    })), a
                }
                ...
                function c(t, e, n) {
                    var o = n.getLineHeight(t.styles.fontSize), r = t.padding("vertical"), i = Math.floor((e - r) / o);
                    return Math.max(0, i)
                }

                function f(t, e, n, o, i, a, s) {
                    var u = y(t, e, o, a);
                    if (n.canEntireRowFit(u, s)) g(t, e, n, a, s); else if (function (t, e, n, o) {
                        ...
                        var d = function (t, e, n, o) {
                            ...
                            for (var a = 0, s = 0, u = n.columns; s < u.length; s++) {
                                var d = u[s];
                                if (b = t.cells[d.index]) {
                                    Array.isArray(b.text) || (b.text = [b.text]);
                                    var h = new r.Cell(b.raw, b.styles, b.section);
                                    (h = (0, l.assign)(h, b)).text = [];
                                    var f = c(b, e, o);
                                    b.text.length > f && (h.text = b.text.splice(f, b.text.length));
                                    var g = o.scaleFactor(), p = o.getLineHeightFactor();
                                    b.contentHeight = b.getContentHeight(g, p), b.contentHeight >= e && (b.contentHeight = e, h.styles.minCellHeight -= e), b.contentHeight > t.height && (t.height = b.contentHeight), h.contentHeight = h.getContentHeight(g, p), h.contentHeight > a && (a = h.contentHeight), i[d.index] = h
                                }
                            }
                            var y = new r.Row(t.raw, -1, t.section, i, !0);
                            y.height = a;
                            for (var v = 0, m = n.columns; v < m.length; v++) {
                                var b;
                                d = m[v], (h = y.cells[d.index]) && (h.height = y.height), (b = t.cells[d.index]) && (b.height = t.height)
                            }
                            return y
                        }(n, u, e, t);
                        g(t, e, n, a, s), v(t, e, i, a, s), f(t, e, d, o, i, a, s)
                    } else v(t, e, i, a, s), f(t, e, n, o, i, a, s)
                }

                function g(t, e, n, o, r) {
                    o.x = e.settings.margin.left;
                    for (var i = 0, l = r; i < l.length; i++) {
                        var s = l[i], u = n.cells[s.index];
                        if (u) if (t.applyStyles(u.styles), u.x = o.x, u.y = o.y, !1 !== e.callCellHooks(t, e.hooks.willDrawCell, u, n, s, o)) {
                            p(t, u, o);
                            var d = u.getTextPos();
                            (0, a.default)(u.text, d.x, d.y, {
                                halign: u.styles.halign,
                                valign: u.styles.valign,
                                maxWidth: Math.ceil(u.width - u.padding("left") - u.padding("right"))
                            }, t.getDocument()), e.callCellHooks(t, e.hooks.didDrawCell, u, n, s, o), o.x += s.width
                        } else o.x += s.width; else o.x += s.width
                    }
                    o.y += n.height
                }
                ...
                function p(t, e, n) {
                    var r = e.styles;
                    if (t.getDocument().setFillColor(t.getDocument().getFillColor()), "number" == typeof r.lineWidth) {
                        var i = (0, o.getFillStyle)(r.lineWidth, r.fillColor);
                        i && t.rect(e.x, n.y, e.width, e.height, i)
                    } else "object" == typeof r.lineWidth && (r.fillColor && t.rect(e.x, n.y, e.width, e.height, "F"), function (t, e, n, o) {
                        var r, i, l, a;
                        o.top && (r = n.x, i = n.y, l = n.x + e.width, a = n.y, o.right && (l += .5 * o.right), o.left && (r -= .5 * o.left), s(o.top, r, i, l, a));
                        o.bottom && (r = n.x, i = n.y + e.height, l = n.x + e.width, a = n.y + e.height, o.right && (l += .5 * o.right), o.left && (r -= .5 * o.left), s(o.bottom, r, i, l, a));
                        o.left && (r = n.x, i = n.y, l = n.x, a = n.y + e.height, o.top && (i -= .5 * o.top), o.bottom && (a += .5 * o.bottom), s(o.left, r, i, l, a));
                        o.right && (r = n.x + e.width, i = n.y, l = n.x + e.width, a = n.y + e.height, o.top && (i -= .5 * o.top), o.bottom && (a += .5 * o.bottom), s(o.right, r, i, l, a));

                        function s(e, n, o, r, i) {
                            t.getDocument().setLineWidth(e), t.getDocument().line(n, o, r, i, "S")
                        }
                    }(t, e, n, r.lineWidth))
                }
                ...
                function y(t, e, n, o) {
                    ...
                    return ("everyPage" === i || "lastPage" === i && n) && (r += e.getFootHeight(e.columns)), t.pageSize().height - o.y - r
                }

                function v(t, e, n, r, i, l) {
                    void 0 === i && (i = []), void 0 === l && (l = !1), t.applyStyles(t.userStyles), "everyPage" !== e.settings.showFoot || l || e.foot.forEach((function (n) {
                        return g(t, e, n, r, i)
                    })), e.callEndPageHooks(t, r);
                    var a = e.settings.margin;
                    (0, o.addTableBorder)(t, e, n, r), m(t), e.pageNumber++, e.pageCount++, r.x = a.left, r.y = a.top, n.y = a.top, e.callWillDrawPageHooks(t, r), "everyPage" === e.settings.showHead && (e.head.forEach((function (n) {
                        return g(t, e, n, r, i)
                    })), t.applyStyles(t.userStyles))
                }
                ...
                function m(t) {
                    var e = t.pageNumber();
                    return t.setPage(e + 1), t.pageNumber() === e && (t.addPage(), !0)
                }

                e.drawTable = function (t, e) {
                    var n = e.settings, r = n.startY, a = n.margin, c = {x: a.left, y: r},
                        p = e.getHeadHeight(e.columns) + e.getFootHeight(e.columns), y = r + a.bottom + p;
                    "avoid" === n.pageBreak && (y += e.body.reduce((function (t, e) {
                        return t + e.height
                    }), 0));
                    var b = new i.DocHandler(t);
                    ("always" === n.pageBreak || null != n.startY && y > b.pageSize().height) && (m(b), c.y = a.top), e.callWillDrawPageHooks(b, c);
                    var w = (0, l.assign)({}, c);
                    e.startPageNumber = b.pageNumber(), n.horizontalPageBreak ? function (t, e, n, o) {
                        var r = (0, s.calculateAllColumnsCanFitInPage)(t, e), i = e.settings;
                        if ("afterAllRows" === i.horizontalPageBreakBehaviour) r.forEach((function (r, i) {
                            t.applyStyles(t.userStyles), i > 0 ? v(t, e, n, o, r.columns, !0) : u(t, e, o, r.columns), function (t, e, n, o, r) {
                                t.applyStyles(t.userStyles), e.body.forEach((function (i, l) {
                                    var a = l === e.body.length - 1;
                                    f(t, e, i, a, n, o, r)
                                }))
                            }(t, e, n, o, r.columns), h(t, e, o, r.columns)
                        })); else for (var l = -1, a = r[0], c = function () {
                            var i = l;
                            if (a) {
                                t.applyStyles(t.userStyles);
                                var s = a.columns;
                                l >= 0 ? v(t, e, n, o, s, !0) : u(t, e, o, s), i = d(t, e, l + 1, o, s), h(t, e, o, s)
                            }
                            var c = i - l;
                            r.slice(1).forEach((function (r) {
                                t.applyStyles(t.userStyles), v(t, e, n, o, r.columns, !0), d(t, e, l + 1, o, r.columns, c), h(t, e, o, r.columns)
                            })), l = i
                        }; l < e.body.length - 1;) c()
                    }(b, e, w, c) : (b.applyStyles(b.userStyles), "firstPage" !== n.showHead && "everyPage" !== n.showHead || e.head.forEach((function (t) {
                        return g(b, e, t, c, e.columns)
                    })), b.applyStyles(b.userStyles), e.body.forEach((function (t, n) {
                        var o = n === e.body.length - 1;
                        f(b, e, t, o, w, c, e.columns)
                    })), b.applyStyles(b.userStyles), "lastPage" !== n.showFoot && "everyPage" !== n.showFoot || e.foot.forEach((function (t) {
                        return g(b, e, t, c, e.columns)
                    }))), (0, o.addTableBorder)(b, e, w, c), e.callEndPageHooks(b, c), e.finalY = c.y, t.lastAutoTable = e, t.previousAutoTable = e, t.autoTable && (t.autoTable.previous = e), b.applyStyles(b.userStyles)
                }, e.addPage = v
            }, 224: function (t, e, n) {
                Object.defineProperty(e, "__esModule", {value: !0}), e.calculateAllColumnsCanFitInPage = void 0;
                var o = n(420);

                function r(t, e, n) {
                    var r;
                    void 0 === n && (n = {});
                    var i = (0, o.getPageAvailableWidth)(t, e), l = new Map, a = [], s = [], u = [];
                    e.settings.horizontalPageBreakRepeat, Array.isArray(e.settings.horizontalPageBreakRepeat) ? u = e.settings.horizontalPageBreakRepeat : "string" != typeof e.settings.horizontalPageBreakRepeat && "number" != typeof e.settings.horizontalPageBreakRepeat || (u = [e.settings.horizontalPageBreakRepeat]), u.forEach((function (t) {
                        var n = e.columns.find((function (e) {
                            return e.dataKey === t || e.index === t
                        }));
                        n && !l.has(n.index) && (l.set(n.index, !0), a.push(n.index), s.push(e.columns[n.index]), i -= n.wrappedWidth)
                    }));
                    for (var d = !0, h = null !== (r = null == n ? void 0 : n.start) && void 0 !== r ? r : 0; h < e.columns.length;) if (l.has(h)) h++; else {
                        var c = e.columns[h].wrappedWidth;
                        if (!(d || i >= c)) break;
                        d = !1, a.push(h), s.push(e.columns[h]), i -= c, h++
                    }
                    return {colIndexes: a, columns: s, lastIndex: h - 1}
                }

                e.calculateAllColumnsCanFitInPage = function (t, e) {
                    for (var n = [], o = 0; o < e.columns.length; o++) {
                        var i = r(t, e, {start: o});
                        i.columns.length && (n.push(i), o = i.lastIndex)
                    }
                    return n
                }
            }, 324: function (t, e, n) {
                ...
                function r(t, e, n) {
                    for (var o = e, i = t.reduce((function (t, e) {
                        ...
                        var a = t[l], s = o * (a.wrappedWidth / i), u = a.width + s, d = n(a), h = u < d ? d : u;
                ...
                function i(t, e, n, r, i) {
                    return t.map((function (t) {
                        return function (t, e, n, r, i) {
                            ...
                            if (e = Math.ceil(e * l) / l, e >= (0, o.getStringWidth)(t, n, r)) return t;
                ...
                e.calculateWidths = function (t, e) {
                    !function (t, e) {
                        var n = t.scaleFactor(), r = e.settings.horizontalPageBreak,
                            i = (0, o.getPageAvailableWidth)(t, e);
                        e.allRows().forEach((function (l) {
                            for (var a = 0, s = e.columns; a < s.length; a++) {
                                var u = s[a], d = l.cells[u.index];
                                if (d) {
                                    var h = e.hooks.didParseCell;
                                    e.callCellHooks(t, h, d, l, u, null);
                                    ...
                                    if (d.minReadableWidth = f + d.padding("horizontal"), "number" == typeof d.styles.cellWidth) d.minWidth = d.styles.cellWidth, d.wrappedWidth = d.styles.cellWidth; else if ("wrap" === d.styles.cellWidth || !0 === r) d.contentWidth > i ? (d.minWidth = i, d.wrappedWidth = i) : (d.minWidth = d.contentWidth, d.wrappedWidth = d.contentWidth); else {
                                        var g = 10 / n;
                    ...
                    a && (a = r(n, a, (function (t) {
                        ...
                        return t.minWidth
                    }))), a = Math.abs(a), !e.settings.horizontalPageBreak && a > .1 / t.scaleFactor() && (a = a < 1 ? a : Math.round(a), console.warn("Of the table content, ".concat(a, " units width could not fit page"))), function (t) {
                        ...
                        for (var n = {count: 0, height: 0}, o = 0, r = t.allRows(); o < r.length; o++) {
                            for (var l = r[o], a = 0, s = t.columns; a < s.length; a++) {
                                ...
                                if (d) {
                                    ...
                                    if ("linebreak" === d.styles.overflow) d.text = e.splitTextToSize(d.text, h + 1 / e.scaleFactor(), {fontSize: d.styles.fontSize}); else if ("ellipsize" === d.styles.overflow) d.text = i(d.text, h, d.styles, e, "..."); else if ("hidden" === d.styles.overflow) d.text = i(d.text, h, d.styles, e, ""); else if ("function" == typeof d.styles.overflow) {
                                        var c = d.styles.overflow(d.text, h);
                                        d.text = "string" == typeof c ? [c] : c
                                    }
                                    d.contentHeight = d.getContentHeight(e.scaleFactor(), e.getLineHeightFactor());
                                    var f = d.contentHeight / d.rowSpan;
                                    d.rowSpan > 1 && n.count * n.height < f * d.rowSpan ? n = {
                                        height: f,
                                        count: d.rowSpan
                                    } : n && n.count > 0 && n.height > f && (f = n.height), f > l.height && (l.height = f)
                                }
                            }
                            n.count--
                        }
        ...
        return function () {
            ...
            var e = o(340), n = o(776), i = o(664), l = o(972), a = o(260);
